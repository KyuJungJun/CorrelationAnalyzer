...
if __name__ == '__main__':
    ...
    result_rot.count_rot_from_graph_each_time_atomwise(n_process=16, split=2000, part_index=int(args.part_index))#, radian)
    result_rot.count_rot_from_graph_from_init_atomwise(n_process=16, split=2000, part_index=int(args.part_index))# radian)
